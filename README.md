...
**Agente Fílmico** is a digital tool that lets users *converse* with a film archive. Instead of browsing catalogues or filtering by metadata, visitors ask questions in plain language. An AI curatorial agent retrieves relevant shots, interprets the collection, and responds with commentary and playlists.

This prototype showcases the **MAFI (Mapa Fílmico de un País)** collection—short documentaries by the Chilean Film Collective MAFI. By working with 50 to 100 annotated films, we're testing how conversational interaction can open new avenues to access archival materials.
...
By making the MAFI archive explorable through dialogue, users can ask about landscapes, social themes, specific regions, or creative approaches—and receive curated playlists with context.
