...
This document covers the technical architecture, configuration, and development setup for Agente Fílmico. For a project overview and setup guide aimed at archive operators, see the [main README](../README.md).
